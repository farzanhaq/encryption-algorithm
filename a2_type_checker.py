...
result = a2.cipher_functions.clean_message('abc')
...
result = a2.cipher_functions.encrypt_letter('A', 1)
...
result = a2.cipher_functions.decrypt_letter('B', 1)
assert isinstance(result, str) and len(result) == 1, \
...
result = a2.cipher_functions.swap_cards(sample_deck, 1)
...
result = a2.cipher_functions.get_small_joker_value(sample_deck)
...
result = a2.cipher_functions.get_big_joker_value(sample_deck)
assert isinstance(result, int), \
...
result = a2.cipher_functions.move_small_joker(sample_deck)
assert result is None, \
...
result = a2.cipher_functions.move_big_joker(sample_deck)
assert result is None, \
...
result = a2.cipher_functions.triple_cut(sample_deck)
assert result is None, \
...
result = a2.cipher_functions.insert_top_to_bottom(sample_deck)
assert result is None, \
...
result = a2.cipher_functions.get_card_at_top_index(sample_deck)
assert isinstance(result, int), \
...
result = a2.cipher_functions.get_next_keystream_value(sample_deck)
assert isinstance(result, int), \
...
result = a2.cipher_functions.process_messages(sample_deck, ['A', 'B', 'C'], 'd')
...
result = a2.cipher_functions.read_messages(open('secret1.txt'))
assert isinstance(result, list), \
...
result = a2.cipher_functions.is_valid_deck([1, 2, 3])
...
result = a2.cipher_functions.read_deck(open('deck1.txt'))
assert isinstance(result, list), \
